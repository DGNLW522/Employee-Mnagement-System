    ...
    return (
        <div>
            <ManagePeopleContainer className="peoplePage" id='managePeople'>
                <h3 className="peopleTitle">PEOPLE MANAGEMENT</h3>
                <ManagePeopleH1>Select task to continue</ManagePeopleH1>
                <ManagePeopleWrapper>
                    <ManagePeopleCard>
                        <ManagePeopleH2>ADD NEW PEOPLE</ManagePeopleH2>
                        <ManagePeopleIcon src={addPeople} />
                        <h4><NavLink to='/create'>Continue</NavLink></h4>

                    </ManagePeopleCard>
                    <ManagePeopleCard>
                        <ManagePeopleH2>VIEW PEOPLE</ManagePeopleH2>
                    ...
                    <ManagePeopleCard>
                        <ManagePeopleH2>GENERATE PEOPLE REPORT</ManagePeopleH2>
